void run(string name="Sherpa", string comp="a"){
  ...
  string path="/Users/grevtsov/Documents/working_files/ttH/ttH-ML/Combination_ttV/Files/particle_level/"+name1+"d.root";
  cout << "path = " << path<< endl;
  ...
  //ch->SetProof();
  ch->Process("souce/partlevel_ttW.C+",name.c_str());
}
