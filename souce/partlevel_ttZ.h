...
#ifndef partlevel_ttZ_h
#define partlevel_ttZ_h
...
class partlevel_ttZ : public TSelector {
public :
   ...
   TTreeReaderValue<Int_t> particle_level_ttZ = {fReader, "particle_level_ttZ"};
   //add taus 020919
 ...
 partlevel_ttZ(TTree * /*tree*/ =0):fNumberOfEvents(0)  { }
   virtual ~partlevel_ttZ() { }
   ...
   ClassDef(partlevel_ttZ,0);

};

#endif

#ifdef partlevel_ttZ_cxx
void partlevel_ttZ::Init(TTree *tree)
{

   fReader.SetTree(tree);
}

Bool_t partlevel_ttZ::Notify()
{
