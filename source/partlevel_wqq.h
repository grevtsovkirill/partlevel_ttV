...
#ifndef partlevel_wqq_h
#define partlevel_wqq_h
...
class partlevel_wqq : public TSelector {
public :
 ...
 partlevel_wqq(TTree * /*tree*/ =0):fNumberOfEvents(0)  { }
   ...
   ClassDef(partlevel_wqq,0);

};

#endif

#ifdef partlevel_wqq_cxx
void partlevel_wqq::Init(TTree *tree)
{

   fReader.SetTree(tree);
}

Bool_t partlevel_wqq::Notify()
{
